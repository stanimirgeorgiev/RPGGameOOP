    ...
    public class Designer
    {
        ...
        public void DrawMap(Tile[][] map)
        {
            ...
            for (int y = 0; y < Config.GameConfig.GridY; y++)
            {
                ...
                {
                    device.DrawImage(map[y][x].Building.Image, x * Config.GameConfig.TileSize, y * Config.GameConfig.TileSize);
                }
            }
            ...
            for (int y = 0; y < Config.GameConfig.GridY; y++)
            {
                for (int x = 0; x < Config.GameConfig.GridX; x++)
                {
                         ...
                         Config.GameConfig.GridX * Config.GameConfig.TileSize))
                    {
                        ...
                        this.device.DrawImage(foundBot.Image, x * Config.GameConfig.TileSize, y * Config.GameConfig.TileSize);
                    }
